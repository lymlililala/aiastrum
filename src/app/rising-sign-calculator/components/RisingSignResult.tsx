...
import type { RisingSignResult } from "../rising-engine";
import type { RisingT, Lang } from "../rising-i18n";

interface RisingSignResultPanelProps {
  t: RisingT;
  lang: Lang;
  result: RisingSignResult;
  onRecalculate: () => void;
}

export function RisingSignResultPanel({ t, lang, result, onRecalculate }: RisingSignResultPanelProps) {
    ...
    <div className="num-result-container">
      ...
      <div className="num-result-hero">
        ...
        <div className="num-hero-tagline">
          🌅 {t.risingIn} {signName} · {result.degree}°{`${result.minute}`.padStart(2, "0")}′
        </div>
