...
import type { MoonSignResult } from "../moon-engine";
import type { MoonT, Lang } from "../moon-i18n";

interface MoonSignResultPanelProps {
  t: MoonT;
  lang: Lang;
  result: MoonSignResult;
  onRecalculate: () => void;
}

export function MoonSignResultPanel({ t, lang, result, onRecalculate }: MoonSignResultPanelProps) {
    ...
    <div className="num-result-container">
      ...
      <div className="num-result-hero">
        ...
        <div className="num-hero-tagline">
          🌙 {t.moonIn} {signName} · {result.degree}°{`${result.minute}`.padStart(2, "0")}′
        </div>
