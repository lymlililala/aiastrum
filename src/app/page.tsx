...
const TW = {
  ...
  crystalsTitle:     "選水晶",
  crystalsDesc:      "按需求挑選水晶：防護、招財、助眠、愛情，附用法與淨化方法",
  namingTitle:       "墨韻起名",
...
const ZH = {
  ...
  crystalsTitle:     "选水晶",
  crystalsDesc:      "按需求挑选水晶：防护、招财、助眠、爱情，附用法与净化方法",
  namingTitle:       "墨韵起名",
...
const EN = {
  ...
  crystalsTitle:     "Crystal Selector",
  crystalsDesc:      "Find the right stone for your intention — protection, money, sleep, love",
...
const MODULES: ModuleItem[] = [
  ...
  { icon: "💎", href: "/crystals",     titleKey: "crystalsTitle",    descKey: "crystalsDesc",      accentColor: "#67e8f9", bgColor: GLASS_BG, badge: "NEW", category: "western" },
